...
class ModelNN:
    ...
    def create(self):
        ...
        model.add((LSTM(units=128, return_sequences=True, kernel_regularizer=l1_l2(l1=0.01, l2=0.01))))
        model.add(Dropout(0.2))
        model.add(BatchNormalization())

        model.add(LSTM(units=128, return_sequences=False, kernel_regularizer=l1_l2(l1=0.01, l2=0.01)))
        model.add(Dropout(0.2))
        model.add(BatchNormalization())
